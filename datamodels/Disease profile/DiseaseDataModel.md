...
## Data model
A JSON Schema corresponding to this data model can be found [DataModelsSmartCity/datamodels/Disease profile/DiseaseJsonSchema.json] (DataModelsSmartCity/datamodels/Disease profile/DiseaseJsonSchema.json)
